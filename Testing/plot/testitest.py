...
plot_hist_sensor_robot(PATH11,PATH12, axs[0,0])
axs[0,0].set_title("without lense on fabric")
plot_hist_sensor_robot(PATH21,PATH22, axs[1,0])
axs[1,0].set_title("without lense on paper")
plot_hist_sensor_robot(PATH31,PATH32, axs[2,0])
axs[2,0].set_title("without lense on book")
plot_hist_sensor_robot(PATH41,PATH42, axs[3,0])
axs[3,0].set_title("without lense on patterned paper")
plot_hist_sensor_robot(PATH011,PATH012, axs[0,1])
axs[0,1].set_title("with lense on fabric")
plot_hist_sensor_robot(PATH021,PATH022, axs[1,1])
axs[1,1].set_title("with lense on paper")
plot_hist_sensor_robot(PATH031,PATH032, axs[2,1])
axs[2,1].set_title("with lense on book")
plot_hist_sensor_robot(PATH041,PATH042, axs[3,1])
